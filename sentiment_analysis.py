...
def predict(text):
    ...
    if  text!="":
        ...
        predicted_class_label=int(predicted_class_label)
        for key, value in senti_code_url.items():
            if value[0]==predicted_class_label:
                predicted_sentiment_img_url=value[1]
                predicted_sentiment=key
        return predicted_sentiment, predicted_sentiment_img_url
